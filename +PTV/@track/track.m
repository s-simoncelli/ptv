...
%                           Default: 1
%
%   'startingTime'          Number of seconds from the 'endingVideo' video
...
%AUTHOR: Stefano Simoncelli <simoncelli@igb-berlin.de>
    ...
    methods
        ...
        function this = track(varargin)            
            ...
            this.maxTrackFileSize] = validateAndParseInputs(varargin{:}); 
...
function [stereoCalibrationFile, leftCameraPath, rightCameraPath, ...
    ...
    maxTracks, videoFileExtension, maxTrackFileSize] = validateAndParseInputs(varargin)
